    ...
    try {
        ...
        const mailOptions = {
            ...
            <div style="text-align: center;">
                ...
                <br>
                <a href="http://localhost:5173/api/student/verify?id=${createdStudent_id}">
...
const generateAccessAndRefreshTokens = async (stdID) =>{ 
    try {
        // console.log("Generating tokens for Student ID:", stdID);
        const std = await student.findById(stdID)
        
        // if (!std) {
        //     console.error("Student not found:", stdID);
...
const forgetPassword=asyncHandler(async(req,res)=>{
   ...
   <p>${resetToken}</p>
   <p>Thank you for being a valued member of the SkillShare community. If you have any questions or need further assistance, please do not hesitate to contact our support team.</p>
   <p>Best regards,</p>
   <p>The SkillShare Team</p>`
