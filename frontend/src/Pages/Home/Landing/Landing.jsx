  ...
  return (
    ...
    {/* Top Section */}
      <div className="top">
        <div className="left">
          <h1>
          Empowering Minds, Inspiring Futures: <br />Your Gateway to Online Learning with <span className="font-semibold text-amber-400 font-serif text-5xl">SkillShare</span>
          </h1>
          {/*  Search  */}
      ...
      <div className="flex items-center justify-center gap-10">
        {!loading && facList && (
          ...
          <div key={fac._id} className="bg-[#99afbc] p-5 rounded-md ">
            ...
            { fac.enrolledteacher.Email === "nc884514@gmail.com" ?
              <h4><span className="font-bold text-brown-800">Education :</span> Pursuing graduation from GL Bajaj</h4> 
              : 
              <h4><span className="font-bold text-brown-800">Education :</span> Pursuing Post graduation from Galgotiya university</h4>
            }
            { fac.enrolledteacher.Email === "nc884514@gmail.com" ? <h4>0 years of teaching experience</h4> : <h4>1 years of teaching experience</h4>}
          </div>
        )))}
      </div>
      ...
      <div className="about" style={{backgroundColor: "#042439"}}>
        ...
        <div className="content">
          ...
          <p>
            At SkillShare, we believe in the power of education to transform lives. Our platform is designed to be a gateway to knowledge, offering a diverse range of courses and learning experiences for students.
            <h1 className=" bg-blue-700 w-fit py-1 px-3 rounded-sm my-2">Our Story</h1>
            SkillShare was born out of a passion for learning and a desire to make quality education accessible to everyone. We understand the challenges faced by modern learners and strive to provide a solution that is both convenient and effective.
